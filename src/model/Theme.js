...
export default class Theme {
    ...
    * @class
    * @extends module:model/ThemeNoLinks
    * @param themeKey {} 
    * @param name {} 
    * @param description {} 
    * @param icon {} 
    ...
    */
    ...
    constructor(themeKey, name, description, icon, links) {
        ThemeNoLinks.call(this, themeKey, name, description, icon);
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ThemeNoLinks.constructFromObject(data, obj);
