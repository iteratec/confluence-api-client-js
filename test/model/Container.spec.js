...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.Container();
  });
  ...
  describe('Container', function() {
    it('should create an instance of Container', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.Container();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.Container);
    });
