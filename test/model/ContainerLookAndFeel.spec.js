...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContainerLookAndFeel();
  });
  ...
  describe('ContainerLookAndFeel', function() {
    it('should create an instance of ContainerLookAndFeel', function() {
      // uncomment below and update the code to test ContainerLookAndFeel
      //var instane = new TheConfluenceCloudRestApi.ContainerLookAndFeel();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContainerLookAndFeel);
    });
