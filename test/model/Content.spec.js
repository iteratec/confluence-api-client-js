...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.Content();
  });
  ...
  describe('Content', function() {
    it('should create an instance of Content', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.Content();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.Content);
    });
