...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentChildType();
  });
  ...
  describe('ContentChildType', function() {
    it('should create an instance of ContentChildType', function() {
      // uncomment below and update the code to test ContentChildType
      //var instane = new TheConfluenceCloudRestApi.ContentChildType();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentChildType);
    });
