...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentChildren();
  });
  ...
  describe('ContentChildren', function() {
    it('should create an instance of ContentChildren', function() {
      // uncomment below and update the code to test ContentChildren
      //var instane = new TheConfluenceCloudRestApi.ContentChildren();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentChildren);
    });
