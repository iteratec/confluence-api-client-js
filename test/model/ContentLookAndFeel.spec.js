...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentLookAndFeel();
  });
  ...
  describe('ContentLookAndFeel', function() {
    it('should create an instance of ContentLookAndFeel', function() {
      // uncomment below and update the code to test ContentLookAndFeel
      //var instane = new TheConfluenceCloudRestApi.ContentLookAndFeel();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentLookAndFeel);
    });
