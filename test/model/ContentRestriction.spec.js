...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentRestriction();
  });
  ...
  describe('ContentRestriction', function() {
    it('should create an instance of ContentRestriction', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.ContentRestriction();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentRestriction);
    });
