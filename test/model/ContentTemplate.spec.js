...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentTemplate();
  });
  ...
  describe('ContentTemplate', function() {
    it('should create an instance of ContentTemplate', function() {
      // uncomment below and update the code to test ContentTemplate
      //var instane = new TheConfluenceCloudRestApi.ContentTemplate();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentTemplate);
    });
