...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.ContentTemplateUpdate();
  });
  ...
  describe('ContentTemplateUpdate', function() {
    it('should create an instance of ContentTemplateUpdate', function() {
      // uncomment below and update the code to test ContentTemplateUpdate
      //var instane = new TheConfluenceCloudRestApi.ContentTemplateUpdate();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.ContentTemplateUpdate);
    });
