...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.CopyPageHierarchyTitleOptions();
  });
  ...
  describe('CopyPageHierarchyTitleOptions', function() {
    it('should create an instance of CopyPageHierarchyTitleOptions', function() {
      // uncomment below and update the code to test CopyPageHierarchyTitleOptions
      //var instane = new TheConfluenceCloudRestApi.CopyPageHierarchyTitleOptions();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.CopyPageHierarchyTitleOptions);
    });
