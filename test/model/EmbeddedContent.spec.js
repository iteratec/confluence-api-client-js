...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.EmbeddedContent();
  });
  ...
  describe('EmbeddedContent', function() {
    it('should create an instance of EmbeddedContent', function() {
      // uncomment below and update the code to test EmbeddedContent
      //var instane = new TheConfluenceCloudRestApi.EmbeddedContent();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.EmbeddedContent);
    });
