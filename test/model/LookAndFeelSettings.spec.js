...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.LookAndFeelSettings();
  });
  ...
  describe('LookAndFeelSettings', function() {
    it('should create an instance of LookAndFeelSettings', function() {
      // uncomment below and update the code to test LookAndFeelSettings
      //var instane = new TheConfluenceCloudRestApi.LookAndFeelSettings();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.LookAndFeelSettings);
    });
