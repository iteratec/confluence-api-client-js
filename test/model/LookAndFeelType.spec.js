...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.LookAndFeelType();
  });
  ...
  describe('LookAndFeelType', function() {
    it('should create an instance of LookAndFeelType', function() {
      // uncomment below and update the code to test LookAndFeelType
      //var instane = new TheConfluenceCloudRestApi.LookAndFeelType();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.LookAndFeelType);
    });
