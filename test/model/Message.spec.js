...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.Message();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.Message);
    });
