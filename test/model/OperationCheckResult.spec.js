...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.OperationCheckResult();
  });
  ...
  describe('OperationCheckResult', function() {
    it('should create an instance of OperationCheckResult', function() {
      // uncomment below and update the code to test OperationCheckResult
      //var instane = new TheConfluenceCloudRestApi.OperationCheckResult();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.OperationCheckResult);
    });
