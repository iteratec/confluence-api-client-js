...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.PropertyValue();
  });
  ...
  describe('PropertyValue', function() {
    it('should create an instance of PropertyValue', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.PropertyValue();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.PropertyValue);
    });
