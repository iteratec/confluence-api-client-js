...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.Relation();
  });
  ...
  describe('Relation', function() {
    it('should create an instance of Relation', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.Relation();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.Relation);
    });
