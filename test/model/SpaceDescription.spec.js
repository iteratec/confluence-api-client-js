...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.SpaceDescription();
  });
  ...
  describe('SpaceDescription', function() {
    it('should create an instance of SpaceDescription', function() {
      // uncomment below and update the code to test SpaceDescription
      //var instane = new TheConfluenceCloudRestApi.SpaceDescription();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.SpaceDescription);
    });
