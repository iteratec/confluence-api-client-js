...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.SpaceProperty();
  });
  ...
  describe('SpaceProperty', function() {
    it('should create an instance of SpaceProperty', function() {
      // uncomment below and update the code to test SpaceProperty
      //var instane = new TheConfluenceCloudRestApi.SpaceProperty();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.SpaceProperty);
    });
