...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.SpaceWatchUser();
  });
  ...
  describe('SpaceWatchUser', function() {
    it('should create an instance of SpaceWatchUser', function() {
      // uncomment below and update the code to test SpaceWatchUser
      //var instane = new TheConfluenceCloudRestApi.SpaceWatchUser();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.SpaceWatchUser);
    });
