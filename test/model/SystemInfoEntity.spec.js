...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.SystemInfoEntity();
  });
  ...
  describe('SystemInfoEntity', function() {
    it('should create an instance of SystemInfoEntity', function() {
      // uncomment below and update the code to test SystemInfoEntity
      //var instane = new TheConfluenceCloudRestApi.SystemInfoEntity();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.SystemInfoEntity);
    });
