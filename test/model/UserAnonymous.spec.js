...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.UserAnonymous();
  });
  ...
  describe('UserAnonymous', function() {
    it('should create an instance of UserAnonymous', function() {
      // uncomment below and update the code to test UserAnonymous
      //var instane = new TheConfluenceCloudRestApi.UserAnonymous();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.UserAnonymous);
    });
