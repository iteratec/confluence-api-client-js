...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.UserDetails();
  });
  ...
  describe('UserDetails', function() {
    it('should create an instance of UserDetails', function() {
      ...
      //var instane = new TheConfluenceCloudRestApi.UserDetails();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.UserDetails);
    });
