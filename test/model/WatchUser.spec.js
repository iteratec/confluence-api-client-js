...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheConfluenceCloudRestApi.WatchUser();
  });
  ...
  describe('WatchUser', function() {
    it('should create an instance of WatchUser', function() {
      // uncomment below and update the code to test WatchUser
      //var instane = new TheConfluenceCloudRestApi.WatchUser();
      //expect(instance).to.be.a(TheConfluenceCloudRestApi.WatchUser);
    });
